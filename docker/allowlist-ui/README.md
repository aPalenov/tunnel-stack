...
— CORS уже включён на все origin (`*`) по умолчанию. Это упрощает работу из Chrome‑расширения
  и любых клиентских приложений. Помните о безопасности: держите сервис за VPN/файрволом и
  используйте нестандартные креды.
